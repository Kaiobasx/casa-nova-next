...
export const metadata: Metadata = {
  title: "Entrar · Chá de Casa Nova — Kaio & Yas",
  description: "Faça login para acessar a área de convidados.",
};
...
export default function LoginPage() {
  return (
    <section className="min-h-screen bg-gradient-navy noise-overlay flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-96 h-96 rounded-full bg-vinho/10 blur-3xl -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full bg-sky-accent/10 blur-3xl translate-x-1/3 translate-y-1/3 pointer-events-none" />
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <div className="mt-6">
            ...
            <p className="font-poppins text-cream/50 text-sm mt-2">
              Faça login para acessar a lista de presentes
            </p>
          </div>
        </div>

        {/* Form Card */}
        <div className="glass-modal p-8 md:p-10 animate-fade-in-up delay-100">
          {/* Corner ornaments */}
